...
# Image size is fixed at 3840x2160 (4K UHD crop from photo.jpg).
...
# Fixed image dimensions (topology.mlir is generated for 3840x2160)
IMAGE_WIDTH=3840
IMAGE_HEIGHT=2160
...
#define SIFT_IMG_PATH "../applications/18-sift-photo/data/img1.pgm"
