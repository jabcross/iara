...
Fixed image parameters (must match topology.mlir source):
  IMAGE_WIDTH=3840, IMAGE_HEIGHT=2160, IMG_DOUBLE=1
  NUM_OCTAVES=9, N_GPYR=6, NLAYERS=3, NUM_DOG_LAYERS=5, KPT_MAX=351

Valid parallelism levels P must divide tot_image_size (8294400), not just TOTAL_PIX.
Valid ≤20: {1, 2, 3, 4, 5, 6, 8, 9, 10, 12, 15, 16, 18, 20}.
"""
...
OCTAVES_DOWN_N = 6    # FIXED algorithm constant, NOT the parallelism level
