#!/usr/bin/env bash
# Preesm codegen script for 18-sift-photo
...
GENERATOR="$IARA_DIR/applications/18-sift-photo/generate_preesm_scenario.py"
...
# Note: VIDEO_FRAMES > 1 is only supported for vf-omp (IaRa) path.
...
SIFT_APP_DIR="$IARA_DIR/applications/18-sift-photo"
