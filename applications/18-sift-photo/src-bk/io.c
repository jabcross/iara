...
void export_keypoints_to_key_file(IN int *nbKeypoints, IN SiftKpt *keypoints) {
  ...
  static const char filename[] = SIFT_IMG_PATH;
  size_t filenameLength = strlen(filename);
  char newFileName[SIFT_FILE_PATH_LENGTH];
...
void read_pgm(OUT unsigned char *img) {
  ...
  // Use values from sift_config.h (generated by codegen.sh)
