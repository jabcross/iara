...
void config_struct_set_up(int GRID_SIZE, int NUM_KERNELS, int NUM_SCENARIO,
                          OUT Config *config_struct) {
...
void generate_kernel(int NUM_KERNELS, int OVERSAMPLING_FACTOR,
                     int NUM_KERNEL_SUPPORT, int TOTAL_KERNELS_SAMPLES,
...
void convert_vis_to_csv(int NUM_VISIBILITIES, float2 *output_visibilities,
...
// void export_image_to_csv(IN float *image_grid, IN Config * config, int
// GRID_SIZE){
