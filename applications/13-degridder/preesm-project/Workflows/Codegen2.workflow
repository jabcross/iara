...
<dftools:workflow errorOnWarning="true" verboseLevel="INFO" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        pluginId="org.ietr.preesm.memory.bounds.MemoryBoundsEstimator" taskId="Memory Bound Estimator 2">
        <dftools:data key="variables">
            <dftools:variable name="Solver" value="Heuristic"/>
            <dftools:variable name="Verbose" value="False"/>
        </dftools:data>
    ...
    <dftools:dataTransfer from="PiSDF Scheduling"
        sourceport="DAG" targetport="DAG" to="Scripts"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario"
    ...
    <dftools:dataTransfer from="Scripts" sourceport="MemEx"
        targetport="MemEx" to="Memory Bound Estimator 2"/>
</dftools:workflow>
