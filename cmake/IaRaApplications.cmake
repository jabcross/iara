...
function(iara_add_application)
    ...
    if("${scheduler}" STREQUAL "preesm")
        ...
        elseif(DEFINED ENV{IARA_DIR} AND NOT "$ENV{IARA_DIR}" STREQUAL "")
            get_filename_component(_preesm_code_src "$ENV{IARA_DIR}/applications/13-degridder/preesm-project/Code/src" ABSOLUTE)
        endif()
    ...
    if("${scheduler}" STREQUAL "preesm")
        # Locate the degridder Code/include directory (iara-local preesm-project)
        ...
        elseif(DEFINED ENV{IARA_DIR})
            get_filename_component(_degridder_include_dir "$ENV{IARA_DIR}/applications/13-degridder/preesm-project/Code/include" ABSOLUTE)
        endif()
    ...
    elseif("${scheduler}" STREQUAL "preesm")
        ...
        elseif(DEFINED ENV{IARA_DIR})
            list(APPEND test_include_dirs "$ENV{IARA_DIR}/applications/13-degridder/preesm-project/Code/include")
        endif()
    endif()
