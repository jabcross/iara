iara-opt --flatten --iara-canonicalize --virtual-fifo=main-actor=run $IARA_DIR/applications/11-forward-delay/topology.mlir > schedule.mlir
...
clang $FLAGS -g -c  $IARA_DIR/applications/11-forward-delay/*.c
clang++ -std=c++26 $FLAGS -g -c  $IARA_DIR/applications/11-forward-delay/*.cpp
clang++ $FLAGS -g -lm *.o
