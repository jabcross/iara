iara-opt --flatten --iara-canonicalize --virtual-fifo=main-actor=run $IARA_DIR/applications/09-hierarchy/topology.mlir > schedule.mlir
...
clang $FLAGS -g -c  $IARA_DIR/applications/09-hierarchy/*.c
clang++ -std=c++26 $FLAGS -g -c  $IARA_DIR/applications/09-hierarchy/*.cpp
clang++ $FLAGS -g -lm *.o
