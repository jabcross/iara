...
@iara_runtime_data_node_13_output_fifos = global [1 x ptr] [ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 800)], align 8
@iara_runtime_data_node_13_input_fifos = global [1 x ptr] [ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 640)], align 8
@iara_runtime_data_node_401201_output_fifos = global [0 x ptr] undef, align 8
@iara_runtime_data_node_401201_input_fifos = global [1 x ptr] [ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 480)], align 8
@iara_runtime_data_node_12_output_fifos = global [2 x ptr] [ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 480), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 640)], align 8
...
@"edge_1213_12_b[1]->13_c[0]" = constant [26 x i8] c"edge_1213_12_b[1]->13_c[0]"
@"deallocNode_2401201_12_b[0]" = constant [27 x i8] c"deallocNode_2401201_12_b[0]"
@"allocEdge_301201_12_b[1]" = constant [24 x i8] c"allocEdge_301201_12_b[1]"
...
@iara_runtime_data__edge_infos = global [6 x %VirtualFIFO_Edge] [%VirtualFIFO_Edge { %VirtualFIFO_Edge_StaticInfo { i64 2301100, i64 0, i64 -2, i64 4, i64 0, i64 0, i64 0, i64 4, i64 4, i64 -2, i64 -2, i64 1, i64 1 }, %VirtualFIFO_Edge_CodegenInfo { ptr @"allocEdge_301100_11_a[0]", { ptr, i64 } zeroinitializer, ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 104), ptr @iara_runtime_data__node_infos, ptr @iara_runtime_data__node_infos, ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 160) } }, %VirtualFIFO_Edge { %VirtualFIFO_Edge_StaticInfo { i64 1112, i64 1, i64 4, i64 4, i64 0, i64 0, i64 0, i64 4, i64 4, i64 1, i64 1, i64 1, i64 1 }, %VirtualFIFO_Edge_CodegenInfo { ptr @"edge_1112_11_a[0]->12_b[0]", { ptr, i64 } zeroinitializer, ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 312), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 104), ptr @iara_runtime_data__node_infos, ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 480) } }, %VirtualFIFO_Edge { %VirtualFIFO_Edge_StaticInfo { i64 2301201, i64 0, i64 -2, i64 4, i64 1, i64 0, i64 0, i64 4, i64 4, i64 -2, i64 -2, i64 1, i64 1 }, %VirtualFIFO_Edge_CodegenInfo { ptr @"allocEdge_301201_12_b[1]", { ptr, i64 } zeroinitializer, ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 312), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 208), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 208), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 640) } }, %VirtualFIFO_Edge { %VirtualFIFO_Edge_StaticInfo { i64 2401201, i64 -1, i64 4, i64 -3, i64 1, i64 0, i64 0, i64 4, i64 4, i64 1, i64 1, i64 -3, i64 -3 }, %VirtualFIFO_Edge_CodegenInfo { ptr @"deallocNode_2401201_12_b[0]", { ptr, i64 } zeroinitializer, ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 416), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 312), ptr @iara_runtime_data__node_infos, ptr null } }, %VirtualFIFO_Edge { %VirtualFIFO_Edge_StaticInfo { i64 1213, i64 1, i64 4, i64 4, i64 0, i64 0, i64 0, i64 4, i64 4, i64 1, i64 1, i64 1, i64 1 }, %VirtualFIFO_Edge_CodegenInfo { ptr @"edge_1213_12_b[1]->13_c[0]", { ptr, i64 } zeroinitializer, ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 520), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 312), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 208), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__edge_infos, i64 800) } }, %VirtualFIFO_Edge { %VirtualFIFO_Edge_StaticInfo { i64 2401301, i64 -1, i64 4, i64 -3, i64 1, i64 0, i64 0, i64 4, i64 4, i64 1, i64 1, i64 -3, i64 -3 }, %VirtualFIFO_Edge_CodegenInfo { ptr @"deallocNode_2401301_13_c[0]", { ptr, i64 } zeroinitializer, ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 624), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 520), ptr getelementptr inbounds nuw (i8, ptr @iara_runtime_data__node_infos, i64 208), ptr null } }], align 8
...
@"allocNode_301201_12_b[1]" = constant [24 x i8] c"allocNode_301201_12_b[1]"
@node_11_a = constant [9 x i8] c"node_11_a"
@"allocNode_301100_11_a[0]" = constant [24 x i8] c"allocNode_301100_11_a[0]"
@iara_runtime_data__node_infos = global [7 x %VirtualFIFO_Node] [%VirtualFIFO_Node { %VirtualFIFO_Node_StaticInfo { i64 301100, i64 -2, i64 0, i64 -1, i64 2, i64 0 }, %VirtualFIFO_Node_CodegenInfo { ptr @"allocNode_301100_11_a[0]", ptr @iara_runtime_alloc, { ptr, i64 } { ptr @iara_runtime_data_node_301100_input_fifos, i64 0 }, { ptr, i64 } { ptr @iara_runtime_data_node_301100_output_fifos, i64 1 } }, %VirtualFIFO_Node_RuntimeInfo zeroinitializer }, %VirtualFIFO_Node { %VirtualFIFO_Node_StaticInfo { i64 11, i64 4, i64 1, i64 1, i64 1, i64 1 }, %VirtualFIFO_Node_CodegenInfo { ptr @node_11_a, ptr @iara_node_wrapper_11_a, { ptr, i64 } { ptr @iara_runtime_data_node_11_input_fifos, i64 1 }, { ptr, i64 } { ptr @iara_runtime_data_node_11_output_fifos, i64 1 } }, %VirtualFIFO_Node_RuntimeInfo zeroinitializer }, %VirtualFIFO_Node { %VirtualFIFO_Node_StaticInfo { i64 301201, i64 -2, i64 0, i64 1, i64 2, i64 0 }, %VirtualFIFO_Node_CodegenInfo { ptr @"allocNode_301201_12_b[1]", ptr @iara_runtime_alloc, { ptr, i64 } { ptr @iara_runtime_data_node_301201_input_fifos, i64 0 }, { ptr, i64 } { ptr @iara_runtime_data_node_301201_output_fifos, i64 1 } }, %VirtualFIFO_Node_RuntimeInfo zeroinitializer }, %VirtualFIFO_Node { %VirtualFIFO_Node_StaticInfo { i64 12, i64 8, i64 2, i64 3, i64 1, i64 1 }, %VirtualFIFO_Node_CodegenInfo { ptr @node_12_b, ptr @iara_node_wrapper_12_b, { ptr, i64 } { ptr @iara_runtime_data_node_12_input_fifos, i64 2 }, { ptr, i64 } { ptr @iara_runtime_data_node_12_output_fifos, i64 2 } }, %VirtualFIFO_Node_RuntimeInfo zeroinitializer }, %VirtualFIFO_Node { %VirtualFIFO_Node_StaticInfo { i64 401201, i64 -3, i64 1, i64 5, i64 -3, i64 0 }, %VirtualFIFO_Node_CodegenInfo { ptr @"deallocNode_401201_12_b[0]", ptr @iara_runtime_dealloc, { ptr, i64 } { ptr @iara_runtime_data_node_401201_input_fifos, i64 1 }, { ptr, i64 } { ptr @iara_runtime_data_node_401201_output_fifos, i64 0 } }, %VirtualFIFO_Node_RuntimeInfo zeroinitializer }, %VirtualFIFO_Node { %VirtualFIFO_Node_StaticInfo { i64 13, i64 4, i64 1, i64 5, i64 1, i64 1 }, %VirtualFIFO_Node_CodegenInfo { ptr @node_13_c, ptr @iara_node_wrapper_13_c, { ptr, i64 } { ptr @iara_runtime_data_node_13_input_fifos, i64 1 }, { ptr, i64 } { ptr @iara_runtime_data_node_13_output_fifos, i64 1 } }, %VirtualFIFO_Node_RuntimeInfo zeroinitializer }, %VirtualFIFO_Node { %VirtualFIFO_Node_StaticInfo { i64 401301, i64 -3, i64 1, i64 7, i64 -3, i64 0 }, %VirtualFIFO_Node_CodegenInfo { ptr @"deallocNode_401301_13_c[0]", ptr @iara_runtime_dealloc, { ptr, i64 } { ptr @iara_runtime_data_node_401301_input_fifos, i64 1 }, { ptr, i64 } { ptr @iara_runtime_data_node_401301_output_fifos, i64 0 } }, %VirtualFIFO_Node_RuntimeInfo zeroinitializer }], align 8
...
define void @iara_node_wrapper_12_b(i64 %0, { ptr, i64 } %1) !dbg !15 {
  ...
  call void @b(ptr %5, ptr %7), !dbg !21
  ret void, !dbg !22
}

declare !dbg !23 void @iara_runtime_dealloc(i64, { ptr, i64 })

define void @iara_node_wrapper_13_c(i64 %0, { ptr, i64 } %1) !dbg !24 {
  %3 = extractvalue { ptr, i64 } %1, 0, !dbg !25
  %4 = getelementptr %VirtualFIFO_Chunk, ptr %3, i32 0, i32 2, !dbg !26
  %5 = load ptr, ptr %4, align 8, !dbg !27
  call void @c(ptr %5), !dbg !28
  ret void, !dbg !29
}
...
!1 = !DIFile(filename: "schedule.mlir", directory: "/scratch/pedro.ciambra/repos/iara/manual-builds/09-hierarchy")
...
!19 = !DILocation(line: 790, column: 10, scope: !15)
!20 = !DILocation(line: 791, column: 10, scope: !15)
!21 = !DILocation(line: 792, column: 5, scope: !15)
!22 = !DILocation(line: 793, column: 5, scope: !15)
!23 = !DISubprogram(name: "iara_runtime_dealloc", linkageName: "iara_runtime_dealloc", scope: !1, file: !1, line: 795, type: !4, scopeLine: 795, spFlags: DISPFlagOptimized)
!24 = distinct !DISubprogram(name: "iara_node_wrapper_13_c", linkageName: "iara_node_wrapper_13_c", scope: !1, file: !1, line: 796, type: !4, scopeLine: 796, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0)
!25 = !DILocation(line: 797, column: 10, scope: !24)
!26 = !DILocation(line: 798, column: 10, scope: !24)
!27 = !DILocation(line: 799, column: 10, scope: !24)
!28 = !DILocation(line: 800, column: 5, scope: !24)
!29 = !DILocation(line: 801, column: 5, scope: !24)
