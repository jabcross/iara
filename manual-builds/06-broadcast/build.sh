iara-opt --flatten --iara-canonicalize --virtual-fifo=main-actor=run $IARA_DIR/applications/06-broadcast/topology.mlir > schedule.mlir
...
clang $FLAGS -g -c  $IARA_DIR/applications/06-broadcast/*.c
clang++ -std=c++26 $FLAGS -g -c  $IARA_DIR/applications/06-broadcast/*.cpp
clang++ $FLAGS -g -lm *.o
