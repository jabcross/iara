iara-opt --flatten --iara-canonicalize --virtual-fifo=main-actor=run $IARA_DIR/applications/12-average3/topology.mlir > schedule.mlir
...
clang $FLAGS -g -c  $IARA_DIR/applications/12-average3/*.c
clang++ -std=c++26 $FLAGS -g -c  $IARA_DIR/applications/12-average3/*.cpp
clang++ $FLAGS -g -lm *.o
