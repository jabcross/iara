iara-opt --flatten --iara-canonicalize --virtual-fifo=main-actor=run $IARA_DIR/applications/10-multi-rate/topology.mlir > schedule.mlir
...
clang $FLAGS -g -c  $IARA_DIR/applications/10-multi-rate/*.c
clang++ -std=c++26 $FLAGS -g -c  $IARA_DIR/applications/10-multi-rate/*.cpp
clang++ $FLAGS -g -lm *.o
