iara-opt --flatten --iara-canonicalize --virtual-fifo=main-actor=run $IARA_DIR/applications/07-ownership/topology.mlir > schedule.mlir
...
clang $FLAGS -g -c  $IARA_DIR/applications/07-ownership/*.c
clang++ -std=c++26 $FLAGS -g -c  $IARA_DIR/applications/07-ownership/*.cpp
clang++ $FLAGS -g -lm *.o
